...
<div class="main-header">
    ...
    <p>Tác giả: Tạ Thị luyến - Trường PTDTBT Tiểu học Kiên Đài - ĐT: 0368730507</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Tạ Thị Luyến - Trường PTDTBT Tiểu học Kiên Đài - ĐT: 0368730507</div>", unsafe_allow_html=True)
